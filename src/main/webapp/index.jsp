...
<body>
							...
							<div
								...
								<ul id="nav" class="navbar-nav ml-auto">
									...
									<li class="nav-item"><a class="page-scroll"
										href="signInPage.jsp">Add Shop</a></li>
									<li class="nav-item"><a class="page-scroll"
										href="#locateSectionPiece">Locate Store</a></li>
									<li class="nav-item"><a class="page-scroll"
				...
				<div class="col-lg-6">
					<div class="hero-content">
						...
						<a href="signInPage.jsp" rel="nofollow"
							class="main-btn btn-hover wow fadeInUp" data-wow-delay=".6s">Sign
							in</a>
					</div>
				</div>
				<div class="col-lg-6">
	...
	<section id="categories" class="service-section pt-150">
		<br>
		<div class="container">
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="footer-widget wow fadeInUp" data-wow-delay=".4s">
						...
						<ul class="links">
							...
							<li><a href="#locateSectionPiece">Locate Store</a></li>
